...
class DataIngestion:
    def __init__(self , data_ingest_config:DataIngestConfig):
        try:
    ...
    def export_collection_as_dataframe(self):
        ...
        """
        try:
            database_name = self.data_ingest_config.database_name
    ...
    def export_data_into_feature_store(self , dataframe : pd.DataFrame): #raw data
        try:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataingestionartifact = DataIngestionArtifact(trained_file_path= self.data_ingest_config.training_file_path , #Artifacts/02_08_2026_11_30_45/data_ingestion/ingested/train.csv
                                                          test_file_path= self.data_ingest_config.testing_file_path)      #Artifacts/02_08_2026_11_30_45/data_ingestion/ingested/test.csv
